...
document.querySelector("btn btn-lg btn-success formulario__btn").addEventListener('click', saveRegistro);

function saveRegistro(){
	var puser = document.querySelector("usuario").value,
	nombre = document.querySelector("grupo__nombre").value,
	apellidomat = document.querySelector("grupo__apellidomat").value;


addRegistro(puser, nombre, papellidomat)
